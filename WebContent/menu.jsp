...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#dg").datagrid({
			idField:"id",
			url:"MenuServlet?opType=queryByPage",
			...
			columns:[[
				...
				{field:"pcode",title:"pcode",width:100,align:"center"},
	...
	function update(){
        ...
        $("#ff").form("reset");
      	//修改记录的请求地址
		url = "MenuServlet?opType=update&id="+array[0].id;
		//表单填充内容
	...
	<div id="dd" class="easyui-dialog" style="width: 400px;text-align: center;padding: 10px;" closed="true">
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				...
				<tr>
					<td class="right">pcode：</td>
					<td><input type="text" name="pcode" class="easyui-textbox" data-options="required:true"></td>
				</tr>
				<tr>
					<td class="right">名称：</td>
					<td><input type="password" name="name" class="easyui-textbox" data-options="required:true"></td>
				</tr>
				
				<tr>
					<td class="right">url：</td>
					<td><input type="text" name="url" class="easyui-numberbox" data-options="required:true"></td>
				</tr>
				<tr>
					<td class="right">状态：</td>
					<td><input type="text" name="state" class="easyui-datebox" data-options="required:true,editable:false"></td>
				</tr>
				<tr>
					<td class="right">备注说明：</td>
					<td><input type="text" name="remark" class="easyui-numberbox" data-options="required:true"></td>
				</tr>
			</table>
		</form>
	</div>
