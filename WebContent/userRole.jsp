...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#dg").datagrid({
			idField:"id",
			url:"UserRoleServlet?opType=queryByPage",
	...
	function add(){
        ...
        $("#ff").form("reset");
		//新增记录的请求地址
		url = "UserRoleServlet?opType=add";
		//打开弹出框
		openFormDialog();
		//设置弹出框标题
	...
	function update(){
        ...
        $("#ff").form("reset");
      	//修改记录的请求地址
		url = "UserRoleServlet?opType=update&id="+array[0].id;
		//表单填充内容
		...
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				<tr>
					...
					<td><input type="text" name="uid" class="easyui-textbox" data-options="required:true"></td>
				</tr>
				<tr>
					<td class="right">角色编号：</td>
					<td><input type="text" name="rid" class="easyui-textbox" data-options="required:true"></td>
				</tr>
