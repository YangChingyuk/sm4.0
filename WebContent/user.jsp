...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#dg").datagrid({
			idField:"id",
			url:"UserServlet?opType=queryByPage",
	...
	function update(){
        ...
        $("#ff").form("reset");
      	//修改记录的请求地址
		url = "UserServlet?opType=update&id="+array[0].id;
		//表单填充内容
		...
		<form id="ff" method="post">
			<table style="margin: 0 auto;">
				...
				<tr>
					...
					<td><input type="password" name="empId" class="easyui-textbox" data-options="required:true"></td>
				</tr>
				<tr>
